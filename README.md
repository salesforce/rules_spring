...
http_archive(
    name = "rules_spring",
    sha256 = "f2120fdffb97f2830beb4d901a9ac2c3e17536f8bfb98319513e068f16afd34c",
    urls = [
        "https://github.com/salesforce/rules_spring/releases/download/2.2.3/rules-spring-2.2.3.zip",
    ],
)
```
