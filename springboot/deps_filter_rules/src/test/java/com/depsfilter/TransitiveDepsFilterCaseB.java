...
public class TransitiveDepsFilterCaseB {
    ...
    public void testTransitivesExclusion() {
        /*
            ...
            This test verifies:
            - Build-time deps include "@maven//:org_springframework_spring_jdbc", its transitive deps, and "@maven//:org_springframework_spring_web"
            - Excluded deps include transitive deps of @maven//:org_springframework_spring_web, except those that are transitive deps of @maven//:org_springframework_spring_jdbc"
