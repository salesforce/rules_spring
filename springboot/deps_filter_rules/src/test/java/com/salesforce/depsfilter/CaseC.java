...
public class CaseC {
    ...
    */
        ...
        System.out.println("[[[[[[DEBUG]]]]]]" + expectedExcludedTransitives);
        ...
        for (String transitive: expectedNonExcludedTransitives){
            if (!expectedCombinedDepsList.contains(transitive)){
                expectedCombinedDepsList.add(transitive);
            }
        }
    ...
    private void initialTestSetup() {
        ...
        testDeps = List.of("springboot/deps_filter_rules/CaseC.jar",
