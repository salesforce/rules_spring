...
public class DepsFilterExcludeTransitiveTest {
    ...
    public void testTransitivesExclusion() {
        ...
        expectedRuntimeDeps.add("springboot/deps_filter_rules/tests/dependencyset/external_dependencies/compile_and_runtime/DepsFilterExcludeTransitiveTest.jar");
        expectedRuntimeDeps.add("springboot/deps_filter_rules/tests/dependencyset/external_dependencies/compile_and_runtime/libwith_label_exclusions_with_exclude_transitives_test_lib.jar");
