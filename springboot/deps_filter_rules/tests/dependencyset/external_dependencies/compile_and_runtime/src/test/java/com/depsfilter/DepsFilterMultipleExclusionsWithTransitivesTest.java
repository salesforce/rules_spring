...
public class DepsFilterMultipleExclusionsWithTransitivesTest {
    ...
    public void testMultipleExclusionsWithTransitives() {
        ...
        expectedRuntimeDeps.add("springboot/deps_filter_rules/tests/dependencyset/external_dependencies/compile_and_runtime/DepsFilterMultipleExclusionsWithTransitivesTest.jar");
        expectedRuntimeDeps.add("springboot/deps_filter_rules/tests/dependencyset/external_dependencies/compile_and_runtime/libmultiple_exclusions_with_exclude_transitives_test_lib.jar");
