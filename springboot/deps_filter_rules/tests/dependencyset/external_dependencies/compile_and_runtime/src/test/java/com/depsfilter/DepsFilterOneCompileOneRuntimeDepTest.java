...
public class DepsFilterOneCompileOneRuntimeDepTest {
    ...
    public void testOneCompileOneRuntimeDep() {
        ...
        expectedRuntimeDeps.add("springboot/deps_filter_rules/tests/dependencyset/external_dependencies/compile_and_runtime/DepsFilterOneCompileOneRuntimeDepTest.jar");
        expectedRuntimeDeps.add("springboot/deps_filter_rules/tests/dependencyset/external_dependencies/compile_and_runtime/libone_compile_one_runtime_dep_test_lib.jar");
