    ...
    public void testInterfaceImplementationJars() {
        ...
        */
        ...
        List<String> expectedRuntimeDeps = new ArrayList<>(List.of(
            ...
            "springboot/deps_filter_rules/tests/dependencyset/internal_dependencies/compile_and_runtime_2/DepsFilterInterfaceImplementationTest.jar",
            "springboot/deps_filter_rules/tests/dependencyset/internal_dependencies/compile_and_runtime_2/libinterface_impl_test_lib.jar"
        ));
