...
public class DepsFilterMultipleExclusionsWithoutTransitiveTest {

    @Test
    public void testMultipleExclusionsWithoutTransitive() {
        /*
            Checkout _test_multiple_exclusions_without_transitive in compile_and_runtime_2/compile_and_runtime_test.bzl
        */
        ...
        List<String> expectedRuntimeDeps = new ArrayList<>(List.of(
            ...
            "springboot/deps_filter_rules/tests/dependencyset/internal_dependencies/compile_and_runtime_2/DepsFilterMultipleExclusionsWithoutTransitiveTest.jar",
            "springboot/deps_filter_rules/tests/dependencyset/internal_dependencies/compile_and_runtime_2/libmultiple_exclusions_without_transitive_test_lib.jar"
        ));
