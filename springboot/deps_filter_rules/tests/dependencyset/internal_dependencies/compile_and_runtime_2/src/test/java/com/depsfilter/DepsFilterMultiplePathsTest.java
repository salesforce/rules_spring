...
public class DepsFilterMultiplePathsTest {

    @Test
    public void testMultiplePaths() {
        /*
            Checkout _test_multiple_paths in compile_and_runtime_2/compile_and_runtime_test.bzl
        */
        ...
        List<String> expectedRuntimeDeps = new ArrayList<>(List.of(
            ...
            "springboot/deps_filter_rules/tests/dependencyset/internal_dependencies/compile_and_runtime_2/DepsFilterMultiplePathsTest.jar",
            "springboot/deps_filter_rules/tests/dependencyset/internal_dependencies/compile_and_runtime_2/libmultiple_paths_test_lib.jar"
        ));
