...
public class DepsFilterPathBasedExclusionsTest {

    @Test
    public void testPathBasedExclusions() {
        /*
            Checkout _test_path_based_exclusions in compile_and_runtime_2/compile_and_runtime_test.bzl
        */
        ...
        List<String> expectedRuntimeDeps = new ArrayList<>(List.of(
            ...
            "springboot/deps_filter_rules/tests/dependencyset/internal_dependencies/compile_and_runtime_2/DepsFilterPathBasedExclusionsTest.jar",
            "springboot/deps_filter_rules/tests/dependencyset/internal_dependencies/compile_and_runtime_2/libpath_based_exclusions_test_lib.jar"
        ));
