...
def _test_filtered_deps(ctx):
 ...
 dependencyset("deps")
    ...
    Expected Output:
        JARs preserved:
        - test_lib, A, I, E, F, C, D (both runtime and compile-time)
        JARs excluded:
...
def _test_filtered_deps_exclude_transitive(ctx):
 ...
 dependencyset("deps")
    ...
    Expected Output:
        JARs preserved:
        - test_lib, A, I, E (both runtime and compile-time)
        JARs excluded:
...
def _test_path_based_exclusions(ctx):
 ...
 dependencyset("deps")
    ...
    expected_compile_jars = [
        "libexclude_paths_test_lib-hjar.jar",
    ]

    expected_full_compile_jars = [
        "libexclude_paths_test_lib.jar",
    ]
...
def _test_interface_implementation_jars(ctx):
 ...
 dependencyset("deps")
    ...
    Expected Output:
        ...
        - libinterface_impl_test_lib-hjar.jar

        Implementation JARs (full_compile_jars):
        - libinterface_impl_test_lib.jar
    """
    env = unittest.begin(ctx)
    javainfo_filtered = ctx.attr.test_lib[JavaInfo]
...
def _test_multiple_exclusions_with_transitive(ctx):
 ...
 dependencyset("deps")
    ...
    Expected Output:
        JARs preserved:
        - test_lib, A, I, E, F (both runtime and compile-time)
        JARs excluded:
        - B, G and all transitive deps
    """
    env = unittest.begin(ctx)
    ...
    expected_compile_jars = [
        "libmulti_excl_transitives_test_lib-hjar.jar",
    ]

    expected_full_compile_jars = [
        "libmulti_excl_transitives_test_lib.jar",
    ]
...
def _test_multiple_exclusions_without_transitive(ctx):
 ...
 dependencyset("deps")
    ...
    expected_compile_jars = [
        "libmulti_excl_no_transitives_test_lib-hjar.jar",
    ]

    expected_full_compile_jars = [
        "libmulti_excl_no_transitives_test_lib.jar",
    ]
...
def _test_empty_exclusion_lists(ctx):
 ...
 dependencyset("deps")
    ...
    Expected Output:
        All JARs preserved:
        - test_lib, A, I, B, C, D, E, F, G (both runtime and compile-time)
    """
    env = unittest.begin(ctx)
    javainfo_filtered = ctx.attr.test_lib[JavaInfo]
    
    expected_compile_jars = [
        "libempty_exclusions_test_lib-hjar.jar",
    ]

    expected_full_compile_jars = [
        "libempty_exclusions_test_lib.jar",
    ]
