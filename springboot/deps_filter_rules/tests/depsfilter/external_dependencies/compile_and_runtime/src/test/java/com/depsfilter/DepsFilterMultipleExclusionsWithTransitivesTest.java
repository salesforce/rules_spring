...
public class DepsFilterMultipleExclusionsWithTransitivesTest {
    ...
    public void testMultipleExclusionsWithTransitives() {
        ...
        expectedRuntimeDeps.add("springboot/deps_filter_rules/tests/depsfilter/external_dependencies/compile_and_runtime/DepsFilterMultipleExclusionsWithTransitivesTest.jar");
