...
public class DepsFilterMultipleExclusionsWithoutTransitivesTest {
    ...
    public void testMultipleExclusionsWithoutTransitives() {
        ...
        expectedRuntimeDeps.add("springboot/deps_filter_rules/tests/depsfilter/external_dependencies/compile_and_runtime/DepsFilterMultipleExclusionsWithoutTransitivesTest.jar");
