...
public class DepsFilterPathBasedExclusionsComprehensiveTest {
    ...
    public void testPathBasedExclusionsComprehensive() {
        ...
        expectedRuntimeDeps.add("springboot/deps_filter_rules/tests/depsfilter/external_dependencies/compile_and_runtime/DepsFilterPathBasedExclusionsComprehensiveTest.jar");
