...
public class DepsFilterSingleRuntimeDepWithExclusionsTest {
    ...
    public void testSingleRuntimeDepWithExclusions() {
        ...
        expectedRuntimeDeps.add("springboot/deps_filter_rules/tests/depsfilter/external_dependencies/compile_and_runtime/DepsFilterSingleRuntimeDepWithExclusionsTest.jar");
