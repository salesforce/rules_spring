...
public class DepsFilterLabelExclusionsTest {
    ...
    public void testLabelExclusions() {
        ...
        expectedRuntimeDeps.add("springboot/deps_filter_rules/tests/depsfilter/external_dependencies/compile_and_runtime_through_java_library/DepsFilterLabelExclusionsTest.jar");
