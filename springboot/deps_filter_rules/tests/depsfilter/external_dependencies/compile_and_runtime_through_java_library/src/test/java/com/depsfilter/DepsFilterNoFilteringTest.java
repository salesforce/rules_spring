...
public class DepsFilterNoFilteringTest {
    ...
    public void testNoFiltering() {
        ...
        expectedRuntimeDeps.add("springboot/deps_filter_rules/tests/depsfilter/external_dependencies/compile_and_runtime_through_java_library/DepsFilterNoFilteringTest.jar");
