...
public class DepsFilterOneCompileOneRuntimeDepTest {
    ...
    public void testOneCompileOneRuntimeDep() {
        ...
        expectedRuntimeDeps.add("springboot/deps_filter_rules/tests/depsfilter/external_dependencies/compile_and_runtime_through_java_library/DepsFilterOneCompileOneRuntimeDepTest.jar");
        expectedRuntimeDeps.add("springboot/deps_filter_rules/tests/depsfilter/external_dependencies/compile_and_runtime_through_java_library/libbase_lib_with_single_dep_and_runtime_dep.jar");
