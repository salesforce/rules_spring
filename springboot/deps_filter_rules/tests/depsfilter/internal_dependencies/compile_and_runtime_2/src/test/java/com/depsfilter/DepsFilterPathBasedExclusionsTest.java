    ...
    public void testPathBasedExclusions() {
        ...
        */
        ...
        List<String> expectedRuntimeDeps = new ArrayList<>(List.of(
            ...
            "springboot/deps_filter_rules/tests/depsfilter/internal_dependencies/compile_and_runtime_2/liblib_g.jar",
            ...
            "springboot/deps_filter_rules/tests/depsfilter/internal_dependencies/compile_and_runtime_2/DepsFilterPathBasedExclusionsTest.jar"
        ));
